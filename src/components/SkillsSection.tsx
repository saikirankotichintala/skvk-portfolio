...
const ICONS: Record<string, { svg: React.ReactNode; color: string; bg: string }> = {
  ...
  NumPy: {
    color: "#013243", bg: "#E5EEF2",
    svg: (
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <path d="M11.517 0L.374 6.147v11.706L11.517 24l11.143-6.147V6.147zm0 1.25l9.977 5.504v11.009l-9.977 5.504-9.977-5.504V6.754zm-4.31 3.48v3.63H3.56v1.23h3.647v3.68H8.47v-3.68h3.648V8.36H8.47V4.73zm5.918 0v3.63h-1.23v1.23h1.23v3.68h3.648V12.34h-3.648V8.36h3.648V7.13h-3.648V4.73z" fill="#013243"/>
      </svg>
    ),
  },
  ...
  Matplotlib: {
    color: "#11557C", bg: "#E6EFF5",
    svg: (
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <circle cx="12" cy="12" r="11" fill="none" stroke="#11557C" strokeWidth="1.4"/>
        <circle cx="12" cy="12" r="7.5" fill="none" stroke="#11557C" strokeWidth="1"/>
        <circle cx="12" cy="12" r="4" fill="none" stroke="#E8762C" strokeWidth="1"/>
        <circle cx="12" cy="12" r="1.5" fill="#E8762C"/>
        {/* M letter */}
        <path d="M7 15.5V9l2.5 4 2.5-4v6.5M14.5 9v6.5M14.5 9l2.5 6.5" fill="none" stroke="#11557C" strokeWidth="1.3" strokeLinecap="round" strokeLinejoin="round"/>
      </svg>
    ),
  },
  ...
  "Exploratory Data Analysis": {
    color: "#0066FF", bg: "#EBF2FF",
    svg: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <rect x="3" y="14" width="3" height="6" rx="1" fill="#0066FF" opacity="0.4"/>
        <rect x="8" y="10" width="3" height="10" rx="1" fill="#0066FF" opacity="0.65"/>
        <rect x="13" y="6" width="3" height="14" rx="1" fill="#0066FF"/>
        <circle cx="18.5" cy="6.5" r="3.5" stroke="#0066FF" strokeWidth="1.6"/>
        <line x1="21" y1="9" x2="23" y2="11" stroke="#0066FF" strokeWidth="1.8" strokeLinecap="round"/>
      </svg>
    ),
  },
  ...
  "Dash (Plotly)": {
    color: "#3F4F75", bg: "#EAECF2",
    svg: (
      <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm0 2.4a9.6 9.6 0 1 1 0 19.2A9.6 9.6 0 0 1 12 2.4zm-4.8 4.8v9.6h1.6V7.2H7.2zm3.2 3.2v6.4h1.6v-6.4h-1.6zm3.2-1.6v8h1.6v-8h-1.6zm3.2 3.2v4.8h1.6v-4.8h-1.6z" fill="#3F4F75"/>
      </svg>
    ),
  },
  ...
  "Groq API / LLaMA 3": {
    color: "#6E56CF", bg: "#F0EBFF",
    svg: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <rect x="6" y="6" width="12" height="12" rx="3" stroke="#6E56CF" strokeWidth="1.8"/>
        <rect x="9" y="9" width="6" height="6" rx="1.5" fill="#6E56CF" opacity="0.25"/>
        <line x1="9" y1="3" x2="9" y2="6" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="15" y1="3" x2="15" y2="6" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="9" y1="18" x2="9" y2="21" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="15" y1="18" x2="15" y2="21" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="3" y1="9" x2="6" y2="9" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="3" y1="15" x2="6" y2="15" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="18" y1="9" x2="21" y2="9" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
        <line x1="18" y1="15" x2="21" y2="15" stroke="#6E56CF" strokeWidth="1.6" strokeLinecap="round"/>
      </svg>
    ),
  },
  ...
  "OOP / DSA": {
    color: "#7C3AED", bg: "#F0EBFD",
    svg: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <rect x="8" y="1" width="8" height="5" rx="1.5" fill="#7C3AED" opacity="0.85"/>
        <line x1="12" y1="6" x2="12" y2="9" stroke="#7C3AED" strokeWidth="1.5"/>
        <line x1="6" y1="9" x2="18" y2="9" stroke="#7C3AED" strokeWidth="1.5"/>
        <line x1="6" y1="9" x2="6" y2="12" stroke="#7C3AED" strokeWidth="1.5"/>
        <line x1="18" y1="9" x2="18" y2="12" stroke="#7C3AED" strokeWidth="1.5"/>
        <rect x="2" y="12" width="8" height="5" rx="1.5" fill="#7C3AED" opacity="0.6"/>
        <rect x="14" y="12" width="8" height="5" rx="1.5" fill="#7C3AED" opacity="0.6"/>
      </svg>
    ),
  },
  ...
  "Problem Solving": {
    color: "#0EA5E9", bg: "#E7F5FD",
    svg: (
      <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" width="28" height="28">
        <path d="M12 2a7 7 0 0 1 4 12.8V17a1 1 0 0 1-1 1H9a1 1 0 0 1-1-1v-2.2A7 7 0 0 1 12 2z" stroke="#0EA5E9" strokeWidth="1.7" fill="#0EA5E9" fillOpacity="0.1"/>
        <path d="M9 19h6M10 21h4" stroke="#0EA5E9" strokeWidth="1.7" strokeLinecap="round"/>
        <path d="M10 14.5v-2l-1.5-2M14 14.5v-2l1.5-2" stroke="#0EA5E9" strokeWidth="1.3" strokeLinecap="round"/>
      ...
      <div className="container" style={{ position: "relative", zIndex: 10 }}>
            ...
            {SKILL_CATEGORIES.map((cat) => (
              <button
                ...
                style={{
                  ...
                  boxShadow: activeCategory === cat.id ? "0 2px 8px rgba(0,0,0,0.10)" : "none",
                }}
              >
                {cat.label}
              </button>
              ...
              return (
                <motion.div
                  ...
                  style={{
                    ...
                    boxShadow: "0 4px 18px rgba(0,0,0,0.04), inset 0 2.5px 0 rgba(255,255,255,0.9)",
                    display: "flex",
        ...
        <motion.div
          ...
          style={{
            ...
            WebkitBackdropFilter: "blur(12px)",
            border: "1px solid rgba(255, 255, 255, 0.8)",
            boxShadow: "0 8px 32px rgba(0,0,0,0.04), inset 0 2px 0 rgba(255,255,255,0.9)",
          }}
        >
          <div
            style={{
